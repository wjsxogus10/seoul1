...
def load_and_merge_data():
    ...
    if not os.path.exists(density_file): density_file = './data/지하철 밀도.csv' # 소문자 처리
...
with col_map:
    ...
    # 부족 순위는 1등(부족함)이 빨간색, 나머지는 값이 클수록 진한색
